...
hoistedDependencies:
  ...
  /@typescript-eslint/experimental-utils/5.62.0(eslint@8.52.0)(typescript@5.2.2):
  ...
  /babel-plugin-named-asset-import/0.3.8(@babel/core@7.23.2):
  ...
  /escodegen/1.14.3:
    escodegen: private
  /eslint-config-react-app/7.0.1(@babel/plugin-syntax-flow@7.22.5)(@babel/plugin-transform-react-jsx@7.22.15)(eslint@8.52.0)(jest@27.5.1)(typescript@5.2.2):
  ...
  /eslint-plugin-jest/25.7.0(@typescript-eslint/eslint-plugin@5.62.0)(eslint@8.52.0)(jest@27.5.1)(typescript@5.2.2):
  ...
  /eslint-plugin-testing-library/5.11.1(eslint@8.52.0)(typescript@5.2.2):
    eslint-plugin-testing-library: public
  /eslint-scope/7.2.2:
    eslint-scope: public
  /eslint-visitor-keys/3.4.3:
    eslint-visitor-keys: public
  /eslint-webpack-plugin/3.2.0(eslint@8.52.0)(webpack@5.89.0):
  ...
  /for-each/0.3.3:
    for-each: private
  /fork-ts-checker-webpack-plugin/6.5.3(eslint@8.52.0)(typescript@5.2.2)(webpack@5.89.0):
...
pendingBuilds: []
prunedAt: Fri, 27 Oct 2023 10:47:47 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  - /fsevents/2.3.3
storeDir: /home/at/.local/share/pnpm/store/v3
